...
async def restore_default_passwords(script_args):
    ...
    from securics.core.common import DEFAULT_RBAC_RESOURCES
    from securics.security import update_user
...
async def reset_rbac_database(script_args):
    ...
    from securics.core.security import rbac_db_factory_reset
...
def get_script_arguments():
    arg_parser = argparse.ArgumentParser(description="Securics RBAC tool: manage resources from the Securics RBAC database")
