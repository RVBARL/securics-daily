...
from securics.core.exception import SecuricsException, SecuricsError, SecuricsInternalError

"""
Securics HIDS Python package
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Securics is a python package to manage OSSEC.
...
try:
    ...
    if python_version.major < 2 or (python_version.major == 2 and python_version.minor < 7):
        raise SecuricsInternalError(999, msg)
...
class Securics:
    ...
    def __init__(self):
        ...
        self.type = 'server'
        self.path = common.SECURICS_PATH
    ...
    def _initialize(self):
        """
        Calculates all Securics installation metadata
        """
        # info DB if possible
        try:
