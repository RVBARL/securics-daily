...
from securics.core.utils import SecuricsDBQuery, SecuricsDBBackend, get_fields_to_nest, plain_dict_to_nested_dict, \
    get_date_from_timestamp
from securics.core.wdb import SecuricsDBConnection


class SecuricsDBQuerySyscheck(SecuricsDBQuery):
    nested_fields = ['value']
    ...
    def __init__(self, agent_id, nested=False, default_sort_field='mtime', min_select_fields=None, *args,
        ...
        super().__init__(backend=SecuricsDBBackend(agent_id), default_sort_field=default_sort_field,
...
def syscheck_delete_agent(agent: str, wdb_conn: SecuricsDBConnection) -> None:
