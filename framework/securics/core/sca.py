...
from securics.core.utils import SecuricsDBQuery, SecuricsDBBackend, get_date_from_timestamp
...
class SecuricsDBQuerySCA(SecuricsDBQuery):
    ...
    def __init__(self, agent_id: str, offset: int, limit: Union[int, None], sort: Union[dict, None],
        ...
        self.default_query = default_query if default_query else \
            SecuricsDBQuerySCA.DEFAULT_QUERY if not distinct else SecuricsDBQuerySCA.DEFAULT_QUERY_DISTINCT
        Agent(agent_id).get_basic_information()  # check if the agent exists

        SecuricsDBQuery.__init__(self, offset=offset, limit=limit, table='sca_policy', sort=sort, search=search,
                              ...
                              min_select_fields=min_select_fields, backend=SecuricsDBBackend(agent_id))
...
class SecuricsDBQuerySCACheck(SecuricsDBQuerySCA):
    ...
    def __init__(self, agent_id: str, select: list, sort: dict, sca_checks_ids: list):
        ...
        SecuricsDBQuerySCA.__init__(self, agent_id=agent_id, offset=0, limit=None, sort=sort, filters={}, search=None,
    ...
    def _parse_select_filter(self, select_fields):
        if select_fields:
            ...
            if not set_select_fields or not set_select_fields.issubset(set_fields_keys):
                ...
                raise SecuricsError(1724, "Allowed select fields: {0}. Fields {1}".format(
...
class SecuricsDBQuerySCACheckIDs(SecuricsDBQuerySCA):
    ...
    def __init__(self, agent_id: str, offset: int, limit: int, filters: dict, search: Union[dict, None], query: str,
        ...
        SecuricsDBQuerySCA.__init__(self, agent_id=agent_id, offset=offset, limit=limit, sort=sort, filters=filters,
...
class SecuricsDBQuerySCACheckRelational(SecuricsDBQuerySCA):
    ...
    def __init__(self, agent_id: str, table: str, id_check_list: list, select: list):
        ...
        SecuricsDBQuerySCA.__init__(self, agent_id=agent_id, default_query=default_query,
...
class SecuricsDBQueryDistinctSCACheck(SecuricsDBQuerySCA):
    ...
    def __init__(self, agent_id: str, offset: int, limit: int, filters: dict, search: Union[dict, None], query: str,
        ...
        with SecuricsDBQuerySCA(agent_id=agent_id, offset=0, limit=None, sort=sort,
        ...
        SecuricsDBQuerySCA.__init__(self, agent_id=agent_id, offset=offset, limit=limit, sort=sort, filters={}, search={},
