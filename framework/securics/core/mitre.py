...
from securics.core.utils import SecuricsDBQuery, SecuricsDBBackend, get_utc_strptime
from securics.core.utils import process_array

# Default request_slice value
DEFAULT_REQUEST_SLICE = 500

# Optimal request_slice values for each SecuricsDBQuery
# TACTICS_REQUEST_SLICE = 500  # Default SecuricsDBQueryMitre request_slice value
...
class SecuricsDBQueryMitre(SecuricsDBQuery):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 distinct: bool = False):
        """Create an instance of the SecuricsDBQueryMitre class.
        ...
        request_slice : int
            Max limit used in the SecuricsDBBacked backend object.
        distinct : bool
        ...
        SecuricsDBQuery.__init__(self, offset=offset, limit=limit, table=table, sort=sort, search=search, select=select,
                              ...
                              backend=SecuricsDBBackend(query_format='mitre', request_slice=request_slice),
                              distinct=distinct)
...
class SecuricsDBQueryMitreMetadata(SecuricsDBQueryMitre):
    """Class that handles the MITRE metadata."""

    TABLE_NAME = 'metadata'

    def __init__(self):
        """Create an instance of the SecuricsDBQueryMitreMetadata class."""

        min_select_fields = {'key', 'value'}
        fields = {'key': 'key', 'value': 'value'}

        SecuricsDBQueryMitre.__init__(self, table=self.TABLE_NAME, min_select_fields=min_select_fields, fields=fields,
...
class SecuricsDBQueryMitreRelational(SecuricsDBQueryMitre, ABC):
    """Abstract class used to overload the _format_data_into_dictionary method of SecuricsDBQueryMitre.
...
class SecuricsDBQueryMitreRelationalPhase(SecuricsDBQueryMitreRelational):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = None, query: str = '', count: bool = True,
        ...
        """Create an instance of the SecuricsDBQueryMitreRelationalPhase class.
...
class SecuricsDBQueryMitreRelationalMitigate(SecuricsDBQueryMitreRelational):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = None, query: str = '', count: bool = True,
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, dict_key: str = None, request_slice: int = DEFAULT_REQUEST_SLICE):
        """Create an instance of the SecuricsDBQueryMitreRelationalMitigate class.
...
class SecuricsDBQueryMitreRelationalUse(SecuricsDBQueryMitreRelational):
...
class SecuricsDBQueryMitreMitigations(SecuricsDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
        ...
        """Create an instance of the SecuricsDBQueryMitreMitigations class.
        ...
        SecuricsDBQueryMitre.__init__(self, table=self.TABLE_NAME, min_select_fields=self.min_select_fields,
    ...
    def _execute_data_query(self):
        ...
        with SecuricsDBQueryMitreRelationalMitigate() as mitre_relational_query:
            techniques = mitre_relational_query.run()

        with SecuricsDBQueryMitreReferences(limit=None, filters={'type': 'mitigation'},
...
class SecuricsDBQueryMitreReferences(SecuricsDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None):
        """Create an instance of the SecuricsDBQueryMitreReferences class.
...
class SecuricsDBQueryMitreTactics(SecuricsDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, distinct: bool = False):
        """Create an instance of the SecuricsDBQueryMitreTactics class.
    ...
    def _execute_data_query(self):
        ...
        with SecuricsDBQueryMitreRelationalPhase() as mitre_relational_query:
            techniques = mitre_relational_query.run()

        with SecuricsDBQueryMitreReferences(limit=None, filters={'type': 'tactic'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
class SecuricsDBQueryMitreTechniques(SecuricsDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, distinct: bool = False):
        """Create an instance of the SecuricsDBQueryMitreTechniques class.
    ...
    def _execute_data_query(self):
        ...
        with SecuricsDBQueryMitreRelationalPhase(dict_key='tech_id') as mitre_relational_query:
            tactics = mitre_relational_query.run()

        with SecuricsDBQueryMitreRelationalMitigate(dict_key='target_id') as mitre_relational_query:
            mitigations = mitre_relational_query.run()

        with SecuricsDBQueryMitreRelationalUse(filters={'target_type': 'technique', 'source_type': 'software'},
                                            dict_key='target_id',
                                            select=['source_id', 'target_id']) as mitre_relational_query:
            software = mitre_relational_query.run()

        with SecuricsDBQueryMitreRelationalUse(filters={'target_type': 'technique', 'source_type': 'group'},
        ...
        with SecuricsDBQueryMitreReferences(limit=None, filters={'type': 'technique'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
class SecuricsDBQueryMitreGroups(SecuricsDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, distinct: bool = False):
        """Create an instance of the SecuricsDBQueryMitreGroups class.
        ...
        SecuricsDBQueryMitre.__init__(self, table=f"`{self.TABLE_NAME}`", min_select_fields=self.min_select_fields,
                                   fields=self.fields, filters=filters, offset=offset, limit=limit, query=query,
                                   count=count, sort=sort, default_sort_field=default_sort_field,
                                   default_sort_order=default_sort_order, search=search,
                                   select=list(set(self.fields.values()).intersection(set(select))),
    ...
    def _execute_data_query(self):
        ...
        with SecuricsDBQueryMitreRelationalUse(filters={'target_type': 'software', 'source_type': 'group'},
                                            select=['source_id', 'target_id']) as mitre_relational_query:
            software = mitre_relational_query.run()
        ...
        with SecuricsDBQueryMitreReferences(limit=None, filters={'type': 'group'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
class SecuricsDBQueryMitreSoftware(SecuricsDBQueryMitre):
    ...
    def _execute_data_query(self):
        ...
        with SecuricsDBQueryMitreReferences(limit=None, filters={'type': 'software'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
def get_mitre_items(mitre_class: callable) -> tuple:
    ...
    mitre_class : callable
        SecuricsDBQueryMitre class used to obtain certain MITRE resources.
