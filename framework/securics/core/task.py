...
class SecuricsDBQueryTask(SecuricsDBQuery):
    ...
    def __init__(self, offset: int = 0, limit: int = common.DATABASE_LIMIT, query: str = '', count: bool = True,
                 ...
                 filters: dict = None):
        """Create an instance of SecuricsDBQueryTasks query.
        ...
        SecuricsDBQuery.__init__(self, offset=offset, limit=limit, table=table, sort=sort, search=search, select=select,
                              ...
                              min_select_fields=min_select_fields, backend=SecuricsDBBackend(query_format='task'))
...
def send_to_tasks_socket(command: dict) -> str:
    ...
    """
    try:
        s = SecuricsSocket(common.TASKS_SOCKET)
    except Exception:
