...
#include "../../wrappers/securics/shared/cluster_op_wrappers.h"
#include "../../wrappers/securics/shared/debug_op_wrappers.h"
#include "../../wrappers/securics/shared/pthreads_op_wrappers.h"
#include "../../wrappers/securics/os_net/os_net_wrappers.h"
#include "../../wrappers/securics/securics_modules/wm_task_manager_wrappers.h"

#include "../../securics_modules/wmodules.h"
#include "../../securics_modules/task_manager/wm_task_manager.h"
#include "../../securics_modules/task_manager/wm_task_manager_tasks.h"
...
void test_wm_task_manager_destroy(void **state)
{
    ...
    expect_string(__wrap__mtinfo, tag, "securics-modulesd:task-manager");
...
void test_wm_task_manager_init_bind_err(void **state)
{
    ...
    expect_string(__wrap__mterror, tag, "securics-modulesd:task-manager");
...
void test_wm_task_manager_dispatch_ok(void **state)
{
    ...
    expect_string(__wrap__mtdebug1, tag, "securics-modulesd:task-manager");
