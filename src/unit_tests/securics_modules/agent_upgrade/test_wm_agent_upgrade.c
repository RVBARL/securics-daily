...
#include "../../wrappers/securics/securics_modules/wm_agent_upgrade_agent_wrappers.h"
...
void test_wm_agent_upgrade_dump_enabled(void **state)
{
    ...
    #ifdef TEST_SERVER
    os_strdup("rvbionics.com/packages", config->manager_config.wpk_repository);
    ...
    assert_string_equal(cJSON_GetObjectItem(conf, "wpk_repository")->valuestring, "rvbionics.com/packages");
    #else
