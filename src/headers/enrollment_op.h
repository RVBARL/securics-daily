 ...
 *
 * Securics agents need to register to a manager before being able to start sending messages
 ...
 * For details on enrollment process @see https://documentation.rvbionics.com/3.12/user-manual/registering/
 */
