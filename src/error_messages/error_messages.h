...
#define HOME_ERROR    "(1108): Unable to find Securics install directory. Export it to SECURICS_HOME environment variable."
...
#define A_QUERY_ERROR           "(1286): Securics-db query error, check wdb logs."
#define INVALID_TYPE            "(1287): Incorrect/unknown type value %s."
#define WDBC_QUERY_EX_ERROR     "(1288): Securics-db query execution error."
...
#define DB_COMPILED           "(5207): Securics not compiled with support for '%s'."
...
/* Securics Logtest error messsages */
...
#define LOGTEST_ERROR_INV_CONF                      "(7304): Invalid securics-logtest configuration"
...
#define SECURICS_HOMEDIR "Securics home directory: %s"
...
#define OS_NORMAL_BUFFER  "securics: Agent buffer: 'normal'."
#define OS_WARN_BUFFER  "securics: Agent buffer: '%d%%'."
#define OS_FULL_BUFFER  "securics: Agent buffer: 'full'."
#define OS_FLOOD_BUFFER "securics: Agent buffer: 'flooded'."
