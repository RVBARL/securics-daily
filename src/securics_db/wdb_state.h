...
typedef struct _securicsdb_breakdown_t {
    uint64_t remove_queries;
    struct timeval remove_time;
} securicsdb_breakdown_t;
...
typedef struct _queries_breakdown_t {
    ...
    securicsdb_breakdown_t securicsdb_breakdown;
} queries_breakdown_t;
...
/**
 * @brief Increment total securicsdb queries counter
 *
 */
void w_inc_securicsdb();

/**
 * @brief Increment remove securicsdb queries counter
 *
 */
void w_inc_securicsdb_remove();

/**
 * @brief Increment remove securicsdb time counter
 *
...
/**
 * @brief Create a JSON object with all the securics-db state information
 * @return JSON object
 */
