...
| `--cppcheck`            | Run cppcheck on the code. Example: `python3 build.py --cppcheck <securics_modules/syscollector|shared_modules/dbsync|shared_modules/rsync|shared_modules/utils|data_provider|syscheckd>` |
