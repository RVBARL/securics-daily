...
/* Securics-logtest's fields names for the requests and responses */
...
/**
 * @brief Initialize Securics Logtest. Initialize the listener and create threads
...
/**
 * @brief Main function of Securics Logtest module
 *
