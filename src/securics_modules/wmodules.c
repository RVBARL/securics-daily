...
int wm_max_eps;             // Maximum events per second sent by OpenScap and CIS-CAT Securics Module
...
int wm_config() {
    ...
    wm_task_nice = getDefine_Int("securics_modules", "task_nice", -20, 19);
    wm_max_eps = getDefine_Int("securics_modules", "max_eps", 1, 1000);
    wm_kill_timeout = getDefine_Int("securics_modules", "kill_timeout", 0, 3600);
...
cJSON *getModulesInternalOptions(void) {
    ...
    cJSON_AddNumberToObject(internals,"securics_modules.task_nice",wm_task_nice);
    cJSON_AddNumberToObject(internals,"securics_modules.max_eps",wm_max_eps);
    cJSON_AddNumberToObject(internals,"securics_modules.kill_timeout",wm_kill_timeout);
    cJSON_AddNumberToObject(internals,"securics_modules.debug",wm_debug_level);
