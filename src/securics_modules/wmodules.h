...
extern int wm_max_eps;          // Maximum events per second sent by OpenScap Securics Module
...
/*
 * @brief Get ID group of Securics user.
 *
 * @return ID group.
 */
...
/*
 * @brief Set ID group of securics modules
 *
