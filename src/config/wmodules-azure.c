...
static const char *AUTHENTICATION_OPTIONS_URL = "https://documentation.rvbionics.com/current/azure/activity-services/prerequisites/credentials.html";
