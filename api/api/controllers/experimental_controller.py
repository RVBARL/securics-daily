...
import securics.ciscat as ciscat
import securics.rootcheck as rootcheck
import securics.syscheck as syscheck
import securics.syscollector as syscollector
...
def check_experimental_feature_value(func):
    ...
    async def wrapper(*args, **kwargs):
        if not configuration.api_conf['experimental_features']:
            raise_if_exc(SecuricsResourceNotFound(1122))
        else:
