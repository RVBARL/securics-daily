...
REQUEST_HEADERS_TEST = {'authorization': 'Basic d2F6dWg6cGFzc3dvcmQxMjM='}  # securics:password123
...
def test_securicsjsonformatter(message, dkt):
    """Check securics json formatter is working as expected.
    ...
    with patch('api.alogging.logging.LogRecord') as mock_record:
        ...
        wjf = alogging.SecuricsJsonFormatter()
        log_record = {}
...
def test_custom_logging(path, hash_auth_context, body, loggerlevel):
    ...
    user, remote, method = ('securics', '1.1.1.1', 'POST')
