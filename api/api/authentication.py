...
import securics.core.utils as core_utils
import securics.rbac.utils as rbac_utils
...
from securics.core.cluster.utils import read_config
from securics.core.common import securics_uid, securics_gid
from securics.rbac.orm import AuthenticationManager, TokenManager, UserRolesManager
from securics.rbac.preprocessor import optimize_resources
...
def generate_keypair():
    ...
    try:
        if not os.path.exists(_private_key_path) or not os.path.exists(_public_key_path):
            ...
            try:
                os.chown(_private_key_path, securics_uid(), securics_gid())
                os.chown(_public_key_path, securics_uid(), securics_gid())
        ...
        raise SecuricsInternalError(6003)
...
def decode_token(token: str) -> dict:
    ...
    try:
        ...
        payload = jwt.decode(token, generate_keypair()[1], algorithms=[JWT_ALGORITHM], audience='Securics API REST')
