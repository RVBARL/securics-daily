...
RETRY_CONFIGURATION_URL = 'https://documentation.rvbionics.com/current/amazon/services/prerequisites/' \
...
class AWSBucket(securics_integration.SecuricsAWSDatabase):
    """
    ...
    def __init__(self, db_table_name, bucket, reparse, access_key, secret_key, profile, iam_role_arn,
        ...
        securics_integration.SecuricsAWSDatabase.__init__(self,
        ...
        def exception_handler(error_txt, error_code):
            if self.skip_on_error:
                ...
                try:
                    ...
                    aws_tools.debug("++ Failed to send message to Securics", 1)
            else:
