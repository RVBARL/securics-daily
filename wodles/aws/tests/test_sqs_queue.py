...
@patch('securics_integration.SecuricsIntegration.__init__', side_effet=securics_integration.SecuricsIntegration.__init__)
def test_aws_sqs_queue_initializes_properly(mock_securics_integration, mock_get_sqs_url, mock_message_processor,
    ...
    integration = sqs_queue.AWSSQSQueue(message_processor=mock_message_processor,
                                        ...
                                        **kwargs)
    mock_securics_integration.assert_called_with(integration,
...
def test_aws_sqs_queue_delete_message(mock_securics_integration, mock_sts_client, mock_get_url):
...
@patch('securics_integration.SecuricsIntegration.get_sts_client')
@patch('securics_integration.SecuricsIntegration.__init__', side_effect=securics_integration.SecuricsIntegration.__init__)
def test_aws_sqs_queue_delete_message_handles_exception_when_deleting_message(mock_securics_integration, mock_sts_client):
...
@patch('securics_integration.SecuricsIntegration.get_sts_client')
@patch('securics_integration.SecuricsIntegration.__init__', side_effect=securics_integration.SecuricsIntegration.__init__)
def test_aws_sqs_queue_fetch_messages(mock_securics_integration, mock_sts_client, mock_get_url):
...
@patch('securics_integration.SecuricsIntegration.get_sts_client')
@patch('securics_integration.SecuricsIntegration.__init__', side_effect=securics_integration.SecuricsIntegration.__init__)
def test_aws_sqs_queue_fetch_messages_handles_exception_when_getting_messages(mock_securics_integration, mock_sts_client):
...
@patch('securics_integration.SecuricsIntegration.get_sts_client')
@patch('securics_integration.SecuricsIntegration.__init__', side_effect=securics_integration.SecuricsIntegration.__init__)
def test_aws_sqs_queue_get_messages(mock_securics_integration, mock_sts_client, mock_fetch):
...
@patch('securics_integration.SecuricsIntegration.get_sts_client')
@patch('securics_integration.SecuricsIntegration.__init__', side_effect=securics_integration.SecuricsIntegration.__init__)
def test_aws_sqs_queue_sync_events(mock_securics_integration, mock_sts_client):
