...
def test_aws_guardduty_bucket_check_guardduty_type(mock_securics_aws_integration, mock_sts,
...
@patch('securics_integration.SecuricsIntegration.get_sts_client')
@patch('securics_integration.SecuricsAWSDatabase.__init__')
def test_aws_guardduty_bucket_check_guardduty_type_handles_exceptions(mock_securics_aws_integration, mock_sts):
...
@patch('securics_integration.SecuricsIntegration.get_sts_client')
@patch('securics_integration.SecuricsAWSDatabase.__init__')
def test_aws_guardduty_bucket_get_full_prefix(mock_securics_aws_integration, mock_sts, mock_service_prefix,
                                              guardduty_native):
...
@patch('securics_integration.SecuricsIntegration.get_sts_client')
@patch('securics_integration.SecuricsAWSDatabase.__init__')
def test_aws_guardduty_bucket_get_base_prefix(mock_securics_aws_integration, mock_sts, guardduty_native: bool):
...
@patch('securics_integration.SecuricsIntegration.get_sts_client')
@patch('securics_integration.SecuricsAWSDatabase.__init__')
def test_aws_guardduty_bucket_iter_regions_and_accounts(mock_securics_aws_integration, mock_sts, guardduty_native: bool):
