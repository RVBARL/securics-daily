...
CREDENTIALS_URL = 'https://documentation.rvbionics.com/current/amazon/services/prerequisites/credentials.html'
...
SECURITY_LAKE_IAM_ROLE_AUTHENTICATION_URL = 'https://documentation.rvbionics.com/current/cloud-security/amazon/services/' \
...
def get_script_arguments():
    parser = argparse.ArgumentParser(usage="usage: %(prog)s [options]",
                                     description="Securics wodle for monitoring AWS",
