...
@patch('gcloud.SecuricsGCloudSubscriber')
...
@patch('pubsub.subscriber.SecuricsGCloudSubscriber.check_permissions')
@patch('pubsub.subscriber.SecuricsGCloudSubscriber.process_messages')
