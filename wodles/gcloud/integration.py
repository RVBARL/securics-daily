...
class SecuricsGCloudIntegration:
    """Class for sending events from Google Cloud to Securics."""

    header = '1:Securics-GCloud:'
    key_name = 'gcp'

    def __init__(self, logger: logging.Logger):
        """Instantiate a SecuricsGCloudIntegration object.
    ...
    def initialize_socket(self):
        ...
        Raises
        ------
        exceptions.SecuricsIntegrationInternalError
        ...
        try:
            ...
            raise exceptions.SecuricsIntegrationInternalError(1)
        except OSError:
            raise exceptions.SecuricsIntegrationInternalError(2, socket_path=ANALYSISD)

    def process_data(self):
        raise NotImplementedError

    def send_msg(self, msg: str):
        """Send an event to the Securics queue.
        ...
        try:
            ...
            raise exceptions.SecuricsIntegrationInternalError(3)
