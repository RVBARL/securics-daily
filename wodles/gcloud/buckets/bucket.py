...
import exceptions
import tools
from integration import SecuricsGCloudIntegration
...
try:
    ...
    raise exceptions.SecuricsIntegrationException(errcode=1003, package=e.name)


class SecuricsGCloudBucket(SecuricsGCloudIntegration):
    ...
    def __init__(self, credentials_file: str, logger: logging.Logger, bucket_name: str, prefix: str = None,
        ...
        self.db_path = join(utils.find_securics_path(), "wodles/gcloud/gcloud.db")
