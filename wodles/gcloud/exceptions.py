...
class SecuricsIntegrationException(Exception):
    """Class that represents an exception for the Securics external integrations.
...
class SecuricsIntegrationInternalError(SecuricsIntegrationException):
    """Class that represents a critical exception for the Securics external integrations."""
    ERRORS = {
        # 1-99 -> Internal errors
        1: {
            'key': 'GCloudSecuricsNotRunning',
            'message': 'Securics must be running'
        },
        2: {
        ...
        3: {
            ...
            'message': 'Error sending event to Securics'
        },
    }

class GCloudError(SecuricsIntegrationException):
