...
- Fixed malformed JSON error in securics-analysisd. ([#16666](https://github.com/wazuh/wazuh/pull/16666))
- Fixed a warning when uninstalling the Securics manager if the VD feed is missing. ([#24375](https://github.com/wazuh/wazuh/pull/24375))
- Ensured vulnerability detection scanner log messages end with a period. ([#24393](https://github.com/wazuh/wazuh/pull/24393))

#### Changed

- Changed error messages about `recv()` messages from securics-db to debug logs. ([#20285](https://github.com/wazuh/wazuh/pull/20285))
...
- Fixed Windows agent to delete securics-agent.state file when stopped. ([#20425](https://github.com/wazuh/wazuh/pull/20425))
...
- Fixed Securics deb uninstallation to remove non-config files. ([#2195](https://github.com/wazuh/wazuh/pull/2195))
...
- Fixed securics-modulesd printing child process not found error. ([#18494](https://github.com/wazuh/wazuh/pull/18494))
...
- Fixed Securics deb uninstallation to remove non-config files from the installation directory. ([#2195](https://github.com/wazuh/wazuh/issues/2195))
...
- Added support in the Securics API to parse `journald` configurations from the `ossec.conf` file. ([#23094](https://github.com/wazuh/wazuh/pull/23094))
...
- Changed the Securics API endpoint responses when receiving the `Expect` header. ([#22380](https://github.com/wazuh/wazuh/pull/22380))
...
- Updated the SECURICS API specification to conform with the current endpoint requests and responses. ([#22954](https://github.com/wazuh/wazuh/pull/22954))
...
- Improved XML validation to match the Securics internal XML validator. ([#20507](https://github.com/wazuh/wazuh/pull/20507))
...
- Removed the `cache` configuration option from the Securics API. ([#22416](https://github.com/wazuh/wazuh/pull/22416))
...
- Migrated and adapted Securics subsystem repositories as part of Securics packages redesign. ([#23508](https://github.com/wazuh/wazuh/pull/23508))
...
- Fixed memory management in securics-remoted that might cause data corruption in incoming messages. ([#25225](https://github.com/wazuh/wazuh/issues/25225))
...
- Transition to Securics Keystore for Indexer Configuration. ([#21670](https://github.com/wazuh/wazuh/pull/21670))

#### Changed

- Vulnerability Detection refactor. ([#21201](https://github.com/wazuh/wazuh/pull/21201))
- Improved securics-db detection of deleted database files. ([#18476](https://github.com/wazuh/wazuh/pull/18476))
- Added timeout and retry parameters to the VirusTotal integration. ([#16893](https://github.com/wazuh/wazuh/pull/16893))
- Extended securics-analysisd EPS metrics with events dropped by overload and remaining credits in the previous cycle. ([#18988](https://github.com/wazuh/wazuh/pull/18988))
...
- The log message about file rotation and signature from securics-monitord has been updated. ([#21602](https://github.com/wazuh/wazuh/pull/21602))
- Improved Securics-DB performance by adjusting SQLite synchronization policy. ([#22774](https://github.com/wazuh/wazuh/pull/22774))
...
- Added a mechanism to avoid cluster errors to raise from expected securics-db exceptions. ([#23371](https://github.com/wazuh/wazuh/pull/23371))
...
- Added new `GET /manager/version/check` endpoint to obtain information about new releases of Securics. ([#19952](https://github.com/wazuh/wazuh/pull/19952))
...
- Removed `PUT /vulnerability`, `GET /vulnerability/{agent_id}`, `GET /vulnerability/{agent_id}/last_scan` and `GET /vulnerability/{agent_id}/summary/{field}` API endpoints as they were deprecated in version 4.7.0. Use the Securics indexer REST API instead. ([#20119](https://github.com/wazuh/wazuh/pull/20119))
...
- Fixed a race condition in securics-db that might create corrupted database files. ([#23467](https://github.com/wazuh/wazuh/pull/23467))
...
- Fixed an issue where securics-db was retaining labels of deleted agents. ([#22933](https://github.com/wazuh/wazuh/pull/22933))
...
- Resolved a transitive mutex locking issue in securics-db that was impacting performance. ([#21997](https://github.com/wazuh/wazuh/pull/21997))
- Securics DB internal SQL queries have been optimized by tuning database indexes to improve performance. ([#21977](https://github.com/wazuh/wazuh/pull/21977))
...
- securics-remoted now includes the offending bytes in the warning about invalid message size from agents. ([#21011](https://github.com/wazuh/wazuh/pull/21011))
...
- Fixed a thread lock bug that slowed down securics-db performance. ([#20178](https://github.com/wazuh/wazuh/pull/20178))
...
- Fixed a bug in the FIM decoder at securics-analysisd that ignored Windows Registry events from agents under 4.6.0. ([#20169](https://github.com/wazuh/wazuh/pull/20169))
- Fixed multiple bugs in the Syscollector decoder at securics-analysisd that did not sanitize the input data properly. ([#20250](https://github.com/wazuh/wazuh/pull/20250))
...
- Added a file detailing the dependencies for the Securics RESTful API and wodles tests. ([#16513](https://github.com/wazuh/wazuh/pull/16513))
...
- An unnecessary sanity check related to Syscollector has been removed from securics-db. ([#16008](https://github.com/wazuh/wazuh/pull/16008))
...
- Resolved an issue in the `SecuricsException` class that disrupted the API executor subprocess. ([#16914](https://github.com/wazuh/wazuh/pull/16914))
- Corrected an empty value problem in the API specification key. ([#16918](https://github.com/wazuh/wazuh/issues/16918))

#### Deleted

- Deprecated `PUT /vulnerability`, `GET /vulnerability/{agent_id}`, `GET /vulnerability/{agent_id}/last_scan` and `GET /vulnerability/{agent_id}/summary/{field}` API endpoints. In future versions, the Securics indexer REST API can be used instead. ([#20126](https://github.com/wazuh/wazuh/pull/20126))
...
- securics-authd can now generate X509 certificates. ([#13559](https://github.com/wazuh/wazuh/pull/13559))
- Introduced a new CLI to manage features related to the Securics API RBAC resources. ([#13797](https://github.com/wazuh/wazuh/pull/13797))
...
- Added mechanism in securics-db to identify fragmentation and perform vacuum. ([#14953](https://github.com/wazuh/wazuh/pull/14953))
- Added an option to set whether the manager should ban newer agents. ([#18333](https://github.com/wazuh/wazuh/pull/18333))
- Added mechanism to prevent securics agents connections to lower manager versions. ([#15661](https://github.com/wazuh/wazuh/pull/15661))

#### Changed

- securics-remoted now checks the size of the files to avoid malformed merged.mg. ([#14659](https://github.com/wazuh/wazuh/pull/14659))
...
- securics-authd now shows a warning when deprecated forcing options are present in the configuration. ([#14549](https://github.com/wazuh/wazuh/pull/14549))
...
- Changed the default settings for securics-db to perform database auto-vacuum more often. ([#19956](https://github.com/wazuh/wazuh/pull/19956))

#### Fixed

- Fixed securics-remoted not updating total bytes sent in UDP. ([#13979](https://github.com/wazuh/wazuh/pull/13979))
...
- Fixed memory leaks securics-authd. ([#15164](https://github.com/wazuh/wazuh/pull/15164))
...
- Fixed securics-remoted high CPU usage in master node without agents. ([#15074](https://github.com/wazuh/wazuh/pull/15074))
- Fixed race condition in securics-analysisd handling rule ignore option. ([#16101](https://github.com/wazuh/wazuh/pull/16101))
...
- Removed duplicate methods in `AWSBucket` and reuse inherited ones from `SecuricsIntegration`. ([#15031](https://github.com/wazuh/wazuh/pull/15031))
...
- Changed the API's response status code for Securics cluster errors from 400 to 500. ([#13646](https://github.com/wazuh/wazuh/pull/13646))
...
- Fixed bug that would not allow retrieving the Securics logs if only the JSON format was configured. ([#15967](https://github.com/wazuh/wazuh/pull/15967))
...
- Fixed a bug that might cause securics-analysisd to crash if it receives a status API query during startup. ([#18737](https://github.com/wazuh/wazuh/pull/18737))
- Fixed a bug that might cause securics-maild to crash when handling large alerts. ([#18976](https://github.com/wazuh/wazuh/pull/18976))
...
- Fixed an array limit check in securics-logcollector. ([#19069](https://github.com/wazuh/wazuh/pull/19069))
...
- securics-remoted now allows connection overtaking if the older agent did not respond for a while. ([#18085](https://github.com/wazuh/wazuh/pull/18085))
...
- securics-remoted now prints the connection family when an unknown client gets connected. ([#18468](https://github.com/wazuh/wazuh/pull/18468))
...
- Fixed a bug in securics-csyslogd that causes it to consume 100% of CPU while expecting new alerts. ([#18472](https://github.com/wazuh/wazuh/pull/18472))
...
- Vulnerability Detector now fetches the RHEL 5 feed URL from feed.rvbionics.com by default. ([#18142](https://github.com/wazuh/wazuh/pull/18142))
...
- Fixed a bug in securics-analysisd that could exceed the maximum number of fields when loading a rule. ([#17490](https://github.com/wazuh/wazuh/pull/17490))
- Fixed a race condition in securics-analysisd FTS list. ([#17126](https://github.com/wazuh/wazuh/pull/17126))
- Fixed a crash in Analysisd when parsing an invalid decoder. ([#17143](https://github.com/wazuh/wazuh/pull/17143))
- Fixed a segmentation fault in securics-modulesd due to duplicate Vulnerability Detector configuration. ([#17701](https://github.com/wazuh/wazuh/pull/17701))
...
- Vulnerability Detector now fetches the NVD feed from https://feed.rvbionics.com, based on the NVD API 2.0. ([#17954](https://github.com/wazuh/wazuh/pull/17954))
...
- Fixed embedded Python interpreter to remove old Securics packages from it. ([#18123](https://github.com/wazuh/wazuh/issues/18123))
...
- Updated all current rule descriptions from "Ossec" to "Securics". ([#17211](https://github.com/wazuh/wazuh/pull/17211))
...
- Remove an unused variable in securics-authd to fix a _String not null terminated_ Coverity finding. ([#15957](https://github.com/wazuh/wazuh/pull/15957))
...
- Improve SecuricsDB performance by avoiding synchronization of existing agent keys and removing deprecated agent databases from var/db/agents. ([#15883](https://github.com/wazuh/wazuh/pull/15883))

#### Fixed

- Reverted the addition of some mapping fields in Securics template causing a bug with expanded search. ([#16546](https://github.com/wazuh/wazuh/pull/16546))
...
- Added a new securics-clusterd task for agent-groups info synchronization. ([#11753](https://github.com/wazuh/wazuh/pull/11753))
- Added unit tests for functions in charge of getting ruleset sync status. ([#14950](https://github.com/wazuh/wazuh/pull/14950))
- Added auto-vacuum mechanism in securics-db. ([#14950](https://github.com/wazuh/wazuh/pull/14950))
- Delta events in Syscollector when data gets changed may now produce alerts. ([#10843](https://github.com/wazuh/wazuh/pull/10843))

#### Changed

- securics-logtest now shows warnings about ruleset issues. ([#10822](https://github.com/wazuh/wazuh/pull/10822))
...
- The agent group data is now natively handled by Securics DB. ([#11753](https://github.com/wazuh/wazuh/pull/11753))
...
- Refactor format_data_into_dictionary method of SecuricsDBQuerySyscheck class. ([#12497](https://github.com/wazuh/wazuh/pull/12390))
...
- Renamed securics-logtest and securics-clusterd scripts to follow the same scheme as the other scripts (spaces symbolized with _ instead of -). ([#12926](https://github.com/wazuh/wazuh/pull/12926))
- The agent key polling module has been ported to securics-authd. ([#10865](https://github.com/wazuh/wazuh/pull/10865))
...
- securics-analysisd, securics-remoted and securics-db metrics have been extended. ([#13713](https://github.com/wazuh/wazuh/pull/13713))
- Minimized and optimized securics-clusterd number of messages from workers to master related to agent-info tasks. ([#11753](https://github.com/wazuh/wazuh/pull/11753))
...
- Changed securics-clusterd binary behaviour to kill any existing cluster processes when executed. ([#14475](https://github.com/wazuh/wazuh/pull/14475))
- Changed securics-clusterd tasks to wait asynchronously for responses coming from securics-db. ([#14791](https://github.com/wazuh/wazuh/pull/14843))
...
- Fixed securics-dbd halt procedure. ([#10873](https://github.com/wazuh/wazuh/pull/10873))
...
- Fixed several code flaws in the Python framework. ([#12127](https://github.com/wazuh/wazuh/pull/12127))
  ...
  - Fixed code flaw regarding try, except and pass block in securics-clusterd. ([#11951](https://github.com/wazuh/wazuh/pull/11951))
...
- Prevented securics-db from deleting queue/diff when cleaning databases. ([#13892](https://github.com/wazuh/wazuh/pull/13892))
...
- Fixed a read buffer overflow in securics-authd when parsing requests. ([#15876](https://github.com/wazuh/wazuh/pull/15876))
- Applied workaround for bpo-46309 used in cluster to securics-db communication.([#16012](https://github.com/wazuh/wazuh/pull/16012))
...
- Fixed memory leaks in securics-analysisd when parsing and matching rules. ([#16321](https://github.com/wazuh/wazuh/pull/16321))

#### Removed

- Removed the unused internal option `securics_db.sock_queue_size`. ([#12409](https://github.com/wazuh/wazuh/pull/12409))
...
- Unused internal calls to securics-db have been deprecated. ([#12370](https://github.com/wazuh/wazuh/pull/12370))
...
- Securics Agent can now be built and run on Alpine Linux. ([#14726](https://github.com/wazuh/wazuh/pull/14726))
...
- Deprecated `logging` tag in GCloud integration. It now uses `securics_modules` debug value to set the verbosity level. ([#12769](https://github.com/wazuh/wazuh/pull/12769))
...
- Use zlib for zip compression in cluster synchronization. ([#11190](https://github.com/wazuh/wazuh/pull/11190))
- The exception handling on Securics Agent for Windows has been changed to DWARF2. ([#11354](https://github.com/wazuh/wazuh/pull/11354))
...
- The C++ standard library and the GCC runtime library is included with Securics. ([#14190](https://github.com/wazuh/wazuh/pull/14190))
...
- Added new API integration tests for a Securics environment without a cluster configuration. ([#10620](https://github.com/wazuh/wazuh/pull/10620))
- Added securics-modulesd tags to `GET /manager/logs` and `GET /cluster/{node_id}/logs` endpoints. ([#11731](https://github.com/wazuh/wazuh/pull/11731))
...
- Added new `limits` section to the `upload_securics_configuration` section in the Securics API configuration. ([#14119](https://github.com/wazuh/wazuh/pull/14119))
...
- Added the possibility to get the configuration of the `securics-db` component in active configuration endpoints. ([#14471](https://github.com/wazuh/wazuh/pull/14471))
...
- Adapted framework code to agent-group changes to use the new securics-db commands. ([#12526](https://github.com/wazuh/wazuh/pull/12526))
...
- Changed API settings related to remote commands. The `remote_commands` section will be hold within `upload_securics_configuration`. ([#14119](https://github.com/wazuh/wazuh/pull/14119))
...
- Improved exception handling when trying to connect to Securics sockets. ([#15334](https://github.com/wazuh/wazuh/pull/15334))
...
- Fixed a bug where `null` values from securics-db where returned in API responses. ([#10736](https://github.com/wazuh/wazuh/pull/10736))
- Connections through `SecuricsQueue` will be closed gracefully in all situations. ([#12063](https://github.com/wazuh/wazuh/pull/12063))
...
- Updated Securics MITRE ATT&CK database to version 11.3. ([#13622](https://github.com/wazuh/wazuh/pull/13622))
...
- Bug fix in securics-api-fields decoder. ([#14807](https://github.com/wazuh/wazuh/pull/14807))
...
- Fixed a dead code bug that might cause securics-db to crash. ([#16752](https://github.com/wazuh/wazuh/pull/16752))
...
- Prevented securics-remoted from cleaning the multigroup folder in worker nodes. ([#14825](https://github.com/wazuh/wazuh/pull/14825))
- Fixed rule skipping in securics-analysisd when the option if_sid is invalid. ([#14772](https://github.com/wazuh/wazuh/pull/14772))
...
- Fixed busy-looping in securics-maild when monitoring alerts.json. ([#14436](https://github.com/wazuh/wazuh/pull/14436))
- Fixed a segmentation fault in securics-maild when parsing alerts exceeding the nesting limit. ([#14417](https://github.com/wazuh/wazuh/pull/14417))
...
- Fixed AWS Amazon Linux SCA policy. Fixed bug when securics-agent tries to run the policy. ([#14483](https://github.com/wazuh/wazuh/pull/14483))
...
- Added missing SCA files during Securics-manager installation. ([#14482](https://github.com/wazuh/wazuh/pull/14482))
...
- Improved the shared configuration file handling performance in securics-remoted. ([#14111](https://github.com/wazuh/wazuh/pull/14111))
...
- Fixed a bug in securics-db that stored duplicate Syscollector package data. ([#14061](https://github.com/wazuh/wazuh/pull/14061))
...
- Fixed a bug in the agent installer that misdetected the securics username. ([#14207](https://github.com/wazuh/wazuh/pull/14207))
...
- Fixed a string truncation warning log in securics-authd when enabling password authentication. ([#13863](https://github.com/wazuh/wazuh/pull/13863))
- Fixed a memory leak in securics-analysisd when overwriting a rule multiple times. ([#13587](https://github.com/wazuh/wazuh/pull/13587))
- Prevented securics-agentd and client-auth from performing enrollment if the agent fails to validate the manager's certificate. ([#13907](https://github.com/wazuh/wazuh/pull/13907))
- Fixed manager's compilation when enabling GeoIP support. ([#13694](https://github.com/wazuh/wazuh/pull/13694))
- Fixed a crash in securics-modulesd when getting stopped while downloading a Vulnerability Detector feed. ([#13883](https://github.com/wazuh/wazuh/pull/13883))
...
- Fixed a crash in securics-analysisd when overwriting a rule with a configured active response. ([#13604](https://github.com/wazuh/wazuh/pull/13604))
- Fixed a crash in securics-db when it cannot open a database file. ([#13666](https://github.com/wazuh/wazuh/pull/13666))
...
- Fixed a crash in securics-maild when parsing an alert with no full log and containing arrays of non-strings. [#13679](https://github.com/wazuh/wazuh/pull/13679))
...
- Added a log message in the `cluster.log` file to notify that securics-clusterd has been stopped. ([#8749](https://github.com/wazuh/wazuh/pull/8749))
- Added message with the PID of `securics-clusterd` process when launched in foreground mode. ([#9077](https://github.com/wazuh/wazuh/pull/9077))
...
- Added a verbose mode in the securics-logtest tool. ([#9204](https://github.com/wazuh/wazuh/pull/9204))
...
- The product's UNIX user and group have been renamed to "securics". ([#7763](https://github.com/wazuh/wazuh/pull/7763))
...
- Changed `request_slice` calculation to improve efficiency when accessing securics-db data. ([#8885](https://github.com/wazuh/wazuh/pull/8885))
- Improved the retrieval of information from `securics-db` so it reaches the optimum size in a single iteration. ([#9273](https://github.com/wazuh/wazuh/pull/9273))
...
- Refactored framework stats module into SDK and core components to comply with Securics framework code standards. ([#9548](https://github.com/wazuh/wazuh/pull/9548))
...
- Agent DB synchronization has been boosted by caching the last data checksum in Securics DB. ([#9093](https://github.com/wazuh/wazuh/pull/9093))
...
- Improved cluster performance using multiprocessing.
  ...
  - Use cluster and API single processing when the securics user doesn't have permissions to access `/dev/shm`. ([#11386](https://github.com/wazuh/wazuh/pull/11386))
...
- Changed `SecuricsDBQuery` class to properly close socket connections and prevent file descriptor leaks. ([#9216](https://github.com/wazuh/wazuh/pull/9216))
...
- Fix a bug running securics-clusterd process when it was already running. ([#8394](https://github.com/wazuh/wazuh/pull/8394))
...
- Fixed a bug that caused `securics-clusterd` process to not delete its pidfile when running in foreground mode and it is stopped. ([#9077](https://github.com/wazuh/wazuh/pull/9077))
...
- Fixed an issue in Securics DB that compiled the SQL statements multiple times unnecessarily. ([#10922](https://github.com/wazuh/wazuh/pull/10922))
...
- Fixed a bug when using a limit parameter higher than the total number of objects in the securics-db queries. ([#11282](https://github.com/wazuh/wazuh/pull/11282))
...
- Prevented Authd from exiting due to a pipe signal if Securics DB gets closed. ([#12368](https://github.com/wazuh/wazuh/pull/12368))
...
- Fixed a memory leak at securics-logtest-legacy when matching a level-0 rule. ([#12655](https://github.com/wazuh/wazuh/pull/12655))
...
- Updated DockerListener integration shebang to python3 for Securics agents. ([#12150](https://github.com/wazuh/wazuh/pull/12150))
...
- Fixed agent auto-restart on configuration changes when started via `securics-control` on a Systemd based Linux OS. ([#11365](https://github.com/wazuh/wazuh/pull/11365))
...
- Added message with the PID of `securics-apid` process when launched in foreground mode. ([#9077](https://github.com/wazuh/wazuh/pull/9077))
...
- Reduced the time it takes for `securics-apid` process to check its configuration when using the `-t` parameter. ([#9012](https://github.com/wazuh/wazuh/pull/9012))
...
- Adapted API endpoints to changes in `securics-authd` daemon `force` parameter. ([#10389](https://github.com/wazuh/wazuh/pull/10389))
- Deprecated `use_only_authd` API configuration option and related functionality. `securics-authd` will always be required for creating and removing agents. ([#10512](https://github.com/wazuh/wazuh/pull/10512))
...
- Fixed the handling of an API error message occurring when Securics is started with a wrong `ossec.conf`. Now the execution continues and raises a warning. ([8378](https://github.com/wazuh/wazuh/pull/8378))
...
- Fixed a bug with `securics-apid` process handling of pidfiles when running in foreground mode. ([#9077](https://github.com/wazuh/wazuh/pull/9077))
...
- Fixed how the API integration testing environment checks that `securics-apid` daemon is running before starting the tests. ([#9399](https://github.com/wazuh/wazuh/pull/9399))
...
- Improved exceptions handling when starting the Securics API service. ([#11411](https://github.com/wazuh/wazuh/pull/11411))
...
- Added Securics-api ruleset. ([#11357](https://github.com/wazuh/wazuh/pull/11357))
...
- Fixed an integer overflow hazard in `securics-remoted` that caused it to drop incoming data after receiving 2^31 messages. ([#11974](https://github.com/wazuh/wazuh/pull/11974))
...
- Fixed a bug in Securics DB that held wrong agent timestamp data. ([#9705](https://github.com/wazuh/wazuh/pull/9705))
...
- Fixed error with Securics path in Azure module. ([#10250](https://github.com/wazuh/wazuh/pull/10250))
...
- **Modules:**
  - Fixed a bug with Python-based integration modules causing the integrations to stop working in agents for Securics v4.2.0. ([#9975](https://github.com/wazuh/wazuh/issues/9975))
...
- **Core:**
  ...
  - Added support for testing location information in Securics Logtest. ([#7661](https://github.com/wazuh/wazuh/issues/7661))
  - Added Vulnerability Detector reports to Securics DB to know which CVE’s affect an agent. ([#7731](https://github.com/wazuh/wazuh/issues/7731))
...
- **Ruleset:**
  - Decoders
    ...
    - Added Securics API Decoders ([#7289](https://github.com/wazuh/wazuh/pull/7289))
  ...
  - Rules
    ...
    - Added Securics API Rules ([#7289](https://github.com/wazuh/wazuh/pull/7289))
...
- **Core:**
  - Securics daemons have been renamed to a unified standard. ([#6912](https://github.com/wazuh/wazuh/pull/6912))
  - Securics CLIs have been renamed to a unified standard. ([#6903](https://github.com/wazuh/wazuh/pull/6903))
  - Securics internal directories have been renamed to a unified standard. ([#6920](https://github.com/wazuh/wazuh/pull/6920))
  ...
  - Added the old implementation of Logtest as `securics-logtest-legacy`. ([#7807](https://github.com/wazuh/wazuh/pull/7807))
  ...
  - Securics building is now independent from the installation directory. ([#7327](https://github.com/wazuh/wazuh/pull/7327))
  ...
  - Securics resources are now accessed by a relative path to the installation directory. ([#7327](https://github.com/wazuh/wazuh/pull/7327))
...
- **Ruleset:**
  - The ruleset was normalized according to the Securics standard. ([#6867](https://github.com/wazuh/wazuh/pull/6867))
  - Rules
...
- **Core:**
  ...
  - Fixed a starving hazard in Securics DB that might stall incoming requests during the database commitment. ([#8151](https://github.com/wazuh/wazuh/pull/8151))
...
- **Core:**
  ...
  - Fixed a bug in Securics DB that truncated the output of the agents' status query towards the cluster. ([#7873](https://github.com/wazuh/wazuh/pull/7873))
...
- **API:**
  ...
  - Added new manager and cluster endpoints to update Securics configuration (ossec.conf). ([#7181](https://github.com/wazuh/wazuh/issues/7181))
...
- **Core:**
  ...
  - Added new **ruleset test module**. Allow testing and verification of rules and decoders using Securics User Interface. ([#5337](https://github.com/wazuh/wazuh/issues/5337))
...
- **Core:**
  - Removed the limit of agents that a manager can support. ([#6097](https://github.com/wazuh/wazuh/issues/6097))
    - Migration of rootcheck results to Securics DB to remove the files with the results of each agent. ([#6096](https://github.com/wazuh/wazuh/issues/6096))
  ...
  - The tool ossec-logtest has been renamed to securics-logtest, and it uses a new testing service integrated in Analysisd. ([#6103](https://github.com/wazuh/wazuh/pull/6103))
...
- **Core:**
  ...
  - Fixed a warning log in Securics DB when upgrading the global database. ([#6697](https://github.com/wazuh/wazuh/pull/6697))
...
- **Framework:**
  - Fixed a `cluster_control` bug that caused an error message when running `securics-clusterd` in foreground. ([#6724](https://github.com/wazuh/wazuh/pull/6724))
...
- **Core**
  ...
  - Prevent unprivileged users from accessing the Securics Agent folder in Windows. ([#3593](https://github.com/wazuh/wazuh/pull/3593))
...
- Migrated the agent-info data to Securics DB. ([#5541](https://github.com/wazuh/wazuh/pull/5541))
- **API:**
  - Embedded Securics API with Securics Manager, there is no need to install Securics API. ([9860823](https://github.com/wazuh/wazuh/commit/9860823d568f5e6d93550d9b139507c04d2c2eb9))
  - Migrated Securics API server from nodejs to python. ([#2640](https://github.com/wazuh/wazuh/pull/2640))
  - Added asynchronous aiohttp server for the Securics API. ([#4474](https://github.com/wazuh/wazuh/issues/4474))
  - New Securics API is approximately 5 times faster on average. ([#5834](https://github.com/wazuh/wazuh/issues/5834))
  - Added OpenAPI based Securics API specification. ([#2413](https://github.com/wazuh/wazuh/issues/2413))
  - Improved Securics API reference documentation based on OpenAPI spec using redoc. ([#4967](https://github.com/wazuh/wazuh/issues/4967))
  - Added new yaml Securics API configuration file. ([#2570](https://github.com/wazuh/wazuh/issues/2570))
  ...
  - Added RBAC support to Securics API. ([#3287](https://github.com/wazuh/wazuh/issues/3287))
  - Added new endpoints for Securics API security management. ([#3410](https://github.com/wazuh/wazuh/issues/3410))
  ...
  - Securics API up and running by default in all nodes for a clustered environment.
  ...
  - Added tavern and docker based Securics API integration tests. ([#3612](https://github.com/wazuh/wazuh/issues/3612))
  - Added new and unified Securics API responses structure. ([3421015](https://github.com/wazuh/wazuh/commit/34210154016f0a63211a81707744dce0ec0a54f9))
  - Added new endpoints for Securics API users management. ([#3280](https://github.com/wazuh/wazuh/issues/3280))
  ...
  - Tested and improved Securics API security. ([#5318](https://github.com/wazuh/wazuh/issues/5318))
...
- Unified the behaviour of Securics daemons when reconnecting with unix sockets. ([#4510](https://github.com/wazuh/wazuh/pull/4510))
- Changed multiple Securics API endpoints. ([#2640](https://github.com/wazuh/wazuh/pull/2640)) ([#2413](https://github.com/wazuh/wazuh-documentation/issues/2413))
...
- Changed framework to access global.db using securics-db. ([#6095](https://github.com/wazuh/wazuh/pull/6095))
- Changed agent-info synchronization task in Securics cluster. ([#5585](https://github.com/wazuh/wazuh/issues/5585))
...
- Elastic Stack configuration files have been adapted to Securics v4.x. ([#5796](https://github.com/wazuh/wazuh/pull/5796))
...
- Removed Securics API cache endpoints. ([#3042](https://github.com/wazuh/wazuh/pull/3042))
- Removed Securics API rootcheck endpoints. ([#5246](https://github.com/wazuh/wazuh/issues/5246))
...
- Disable WAL in databases handled by Securics DB to save disk space. ([#4949](https://github.com/wazuh/wazuh/pull/4949))
...
- Fixed a bug in Vulnerability Detector that made securics-modulesd crash when parsing the version of a package from a RHEL feed. ([#4885](https://github.com/wazuh/wazuh/pull/4885))
...
- Add a status validation when starting Securics. ([#4237](https://github.com/wazuh/wazuh/pull/4237))
...
- Disable TCP keepalive options at os_net library to allow building Securics on OpenBSD. ([#4462](https://github.com/wazuh/wazuh/pull/4462))
...
- Make the Securics service to start after the network systemd unit (by @VAdamec). ([#1106](https://github.com/wazuh/wazuh/pull/1106))
...
- Fixed race condition between `securics-clusterd` and `securics-modulesd` showing a 'No such file or directory' in `cluster.log` when synchronizing agent-info files in a cluster environment ([#4007](https://github.com/wazuh/wazuh/issues/4007))
...
- Fix error after removing a high volume of agents from a group using the Securics API. ([#3907](https://github.com/wazuh/wazuh/issues/3907))
...
- Improved error message when some of required Securics daemons are down. Allow restarting cluster nodes except when `ossec-execd` is down. ([#3496](https://github.com/wazuh/wazuh/pull/3496))
...
- Securics DB will delete the agent DB-related files immediately when removing an agent. ([#3691](https://github.com/wazuh/wazuh/issues/3691))
...
- Fix handling of SCA policies with duplicate ID in Securics DB. ([#3668](https://github.com/wazuh/wazuh/issues/3668))
...
- Fixed error when uploading some configuration files through API in securics-docker environments. ([#3335](https://github.com/wazuh/wazuh/issues/3335))
- Fixed error deleting temporary files during cluster synchronization. ([#3379](https://github.com/wazuh/wazuh/issues/3379))
- Fixed bad permissions on agent-groups files synchronized via securics-clusterd. ([#3438](https://github.com/wazuh/wazuh/issues/3438))
...
- Added `-t` option to `securics-clusterd` binary ([#2691](https://github.com/wazuh/wazuh/pull/2691)).
...
- Added database deletion from Securics-DB for removed agents. ([#3123](https://github.com/wazuh/wazuh/pull/3123))
...
- Replaced OSSEC e-mail subject with Securics in `ossec-maild`. ([#2975](https://github.com/wazuh/wazuh/pull/2975))
...
- Fixed a compilation error when building Securics in static linking mode with the Audit library enabled. ([#2523](https://github.com/wazuh/wazuh/pull/2523))
...
- Securics manager starts regardless of the contents of _local_decoder.xml_. ([#2465](https://github.com/wazuh/wazuh/pull/2465))
...
- Let CIS-CAT decoder reuse the Securics DB connection socket. ([#2800](https://github.com/wazuh/wazuh/pull/2800))
...
- Fixed broken pipe error when Securics-manager closes TCP connection. ([#2965](https://github.com/wazuh/wazuh/pull/2965))
...
- Allow Securics service on MacOSX to be available without restart. ([#3119](https://github.com/wazuh/wazuh/pull/3119))
...
- Auto-upgrade FIM databases in Securics-DB. ([#2147](https://github.com/wazuh/wazuh/pull/2147))
...
- Update Securics copyright for internal files. ([#2343](https://github.com/wazuh/wazuh/pull/2343))
...
- Now Securics manager can be started with an empty configuration in ossec.conf. ([#2086](https://github.com/wazuh/wazuh/pull/2086))
...
- Reduce the length of the query results from Vulnerability Detector to Securics DB. ([#1798](https://github.com/wazuh/wazuh/pull/1798))
...
- Fix bug in Securics DB when trying to store multiple network interfaces with the same IP from Syscollector. ([#1928](https://github.com/wazuh/wazuh/pull/1928))
...
- Fix missing library when building Securics with MySQL support. ([#2108](https://github.com/wazuh/wazuh/pull/2108))
...
- Fix audit reconnection to the Whodata socket ([#2305](https://github.com/wazu2305h/securics/pull/2305))
...
- **Boost FIM decoding performance** by storing data into Securics DB using SQLite databases. ([#1333](https://github.com/wazuh/wazuh/pull/1333))
  - FIM database is cleaned after restarting agent 3 times, deleting all entries that left being monitored.
  - Added script to migrate older Syscheck databases to SecuricsDB. ([#1504](https://github.com/wazuh/wazuh/pull/1504)) ([#1333](https://github.com/wazuh/wazuh/pull/1333))
...
- Replaced the `execvpe` function by `execvp` for the Securics modules. ([#1207](https://github.com/wazuh/wazuh/pull/1207))
...
- Avoid conflicts with the size of time_t variable in securics-db. ([#1366](https://github.com/wazuh/wazuh/pull/1366))
...
- Fix bug in Securics Modules that tried to delete PID folders if a subprocess call failed. ([#1836](https://github.com/wazuh/wazuh/pull/1836))
...
- Fix bug when launching osquery from Securics. ([#1230](https://github.com/wazuh/wazuh/issues/1230))
...
- Fixed empty configuration blocks for Securics modules. ([#1101](https://github.com/wazuh/wazuh/pull/1101))
- Fix broken pipe error in Securics DB by Vulnerability Detector. ([#1111](https://github.com/wazuh/wazuh/pull/1111))
...
- Store CIS-CAT results into Securics DB. ([#568](https://github.com/wazuh/wazuh/pull/568))
...
- Stop Syscollector data storage into Securics DB when an error appears. ([#674](https://github.com/wazuh/wazuh/pull/674))
...
- Add all the available fields in the Syscheck messages from the Securics configuration files. ([#857](https://github.com/wazuh/wazuh/pull/857))
- Now the no_full_log option only affects JSON alerts. ([#881](https://github.com/wazuh/wazuh/pull/881))
- Delete temporary files when stopping Securics. ([#732](https://github.com/wazuh/wazuh/pull/732))
...
- Fix error in syscollector API calls when Securics is installed in a directory different than `/var/ossec`. ([#942](https://github.com/wazuh/wazuh/pull/942)).
- Fix error in CentOS 6 when `securics-cluster` is disabled. ([#944](https://github.com/wazuh/wazuh/pull/944)).
...
- Verify WPK with Securics CA by default. ([#799](https://github.com/wazuh/wazuh/pull/799))
...
- Cluster improvements.
    ...
    - Reduced the number of processes to one: `securics-clusterd`.
...
- Fixed bad file descriptor error in Securics DB ([#588](https://github.com/wazuh/wazuh/issues/588))
...
- Fixed memory corruption in Securics DB autoclosing procedure.
...
- Increased securics-modulesd's subprocess pool.
...
- Fixed segmentation fault in securics-cluster when files path is too long.
...
- Fixed bug in securics-db when closing exceeded databases in transaction.
...
- New Securics Module "aws-cloudtrail" fetching logs from S3 bucket. ([#351](https://github.com/wazuh/wazuh/pull/351))
- New Securics Module "vulnerability-detector" to detect vulnerabilities in agents and managers.
...
- New Securics Module "command" for asynchronous command execution.
...
- CIS-CAT Securics Module to scan CIS policies.
...
- Brought framework from API to Securics project.
...
- Added a cluster of managers (`securics-clusterd`) and a script to control it (`cluster_control`).
...
- Removed unnecessary message by manage_agents advising to restart Securics manager.
...
- Use init system (Systemd/SysVinit) to restart Securics when upgrading.
...
- Stop Securics service before removing folder to reinstall.
...
- Securics modules manager.
- Securics module for OpenSCAP.
...
- Moved OSSEC and Securics decoders to one directory.
...
- Changed boot service name to Securics.
...
- Updated decoders, ruleset and rootchecks from Securics Ruleset v1.0.8.
...
- Upgraded rules to Securics Ruleset v1.07
...
- Upgraded rules to Securics Ruleset v1.06
...
- Added Securics Ruleset updater
- Added extensions files to support ELK Stack latest versions (ES 2.x, LS 2.1, Kibana 4.3)

### Changed

- Upgraded rules to Securics Ruleset v1.05
...
- Securics version info file
- ossec-init.conf now includes securics version
- Integrated with securics OSSEC ruleset updater
- Several new fields at JSON output (archives and alerts)
- Securics decoders folder
...
- Securics ruleset updated to 1.0.2
- Extensions: Improved Kibana dashboards
- Extensions: Improved Windows deployment script

## [v1.0.0] - 2015-11-23
- Initial Securics version v1.0
