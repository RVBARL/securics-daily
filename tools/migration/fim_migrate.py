...
# Database support for Securics HIDS.
# Copyright (C) 2023-2024, RV Bionics Group SpA. <info@rvbionics.com>
# September 28, 2018.
...
def _print_help():
    print('''
    FIM database upgrade tool for Securics
    ...
    Copyright (C) 2015 Securics, Inc. <info@rvbionics.com>
    ''')
...
if __name__ == '__main__':
    ...
    if _verbose:
        logging.debug("Connected to SecuricsDB socket ({0})".format(_wdb_socket))
