...
options_template = {'pretext': 'Securics-X -- Alert generated', 'author_name': 'The amazing Securics', 'footer': 'Slack API'}

msg_template = (
    '{"severity": 1, "pretext": "Securics-X -- Alert generated", "title": "alert description", "text": "full log.", '
    ...
    '"full log.", "decoder": {"name": "decoder-name"}, "location": "securics-X", "author_name": "The amazing Securics",'
    '"footer": "Slack API"}'
)
slack_webhook = ''
