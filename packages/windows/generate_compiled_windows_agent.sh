...
help() {
    ...
    echo
    echo "    -b, --branch <branch>     [Optional] Select Git branch to compile Securics code."
    echo "    --sources <path>          [Optional] Absolute path containing securics source code. This option will use local source code instead of downloading it from GitHub. By default: '../../src'."
