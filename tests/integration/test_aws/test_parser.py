...
def test_bucket_and_service_missing(
        test_configuration, metadata, load_securics_basic_configuration, set_securics_configuration,
        configure_local_internal_options_function, truncate_monitored_files, restart_securics_function_without_exception,
        file_monitoring
):
    """
    ...
    parameters:
        ...
        - restart_securics_function_without_exception:
            type: fixture
            brief: Restart the securics service catching the exception.
        - file_monitoring:
            type: fixture
