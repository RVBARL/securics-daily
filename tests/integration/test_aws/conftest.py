...
from securics_testing.modules.aws.utils import (
    create_bucket,
    upload_log_events,
    create_log_group,
    create_log_stream,
...
from securics_testing.constants.aws import US_EAST_1_REGION
...
@pytest.fixture
def restart_securics_function_without_exception(daemon=None):
    """Restart all Securics daemons."""
    try:
