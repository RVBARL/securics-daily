# Copyright (C) 2015-2021, Securics Inc.
...
from . import SECURICS_PYTHON_INTERPRETER_PATH, MOCK_SERVER_PATH, MOCK_SERVER_IMAGE, MOCK_SERVER_CONTAINER
...
def disable_ssl_verification():
    """Modify securics/core/utils.py to avoid SSL certificate verification."""
    file_path = Path(SECURICS_PYTHON_INTERPRETER_PATH, '/securics/core/utils.py')
