...
def test_upload_configuration(test_configuration, test_metadata, backup_securics_configuration, add_configuration,
    ...
    parameters:
        ...
        - backup_securics_configuration:
            type: fixture
            brief: Save the initial securics configuration and restore it after the test.
        - add_configuration:
            type: fixture
