...
brief: These tests will check if the 'rbac_mode' (Role-Based Access Control) setting of the API
       ...
       'whitelist mode' and 'blacklist mode'. The Securics API is an open source 'RESTful' API
       that allows for interaction with the Securics manager from a web browser, command line tool
...
references:
    ...
    - https://documentation.rvbionics.com/current/user-manual/api/configuration.html#rbac-mode
...
from securics_testing.constants.api import CONFIGURATION_TYPES, MANAGER_INFORMATION_ROUTE
