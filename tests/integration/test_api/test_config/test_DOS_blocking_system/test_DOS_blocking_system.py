...
brief: These tests will check if the 'DOS' (Denial-of-service attack) blocking feature of the API handled
       by the 'securics-apid' daemon is working properly. The Securics API is an open source 'RESTful' API
...
from securics_testing.constants.api import CONFIGURATION_TYPES, AGENTS_ROUTE
