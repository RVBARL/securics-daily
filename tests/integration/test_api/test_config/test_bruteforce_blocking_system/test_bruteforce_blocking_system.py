...
brief: These tests will check if the IP blocking feature of the API handled by the 'securics-apid' daemon
       is working properly. The Securics API is an open source 'RESTful' API that allows for interaction
...
references:
    ...
    - https://documentation.rvbionics.com/current/user-manual/api/configuration.html#access
...
from securics_testing.modules.api.patterns import API_LOGIN_ERROR_MSG
from securics_testing.modules.api.utils import login
