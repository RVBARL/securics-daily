...
brief: These tests will check if the set_secure_headers middleware of the API handled by the 'securics-apid' daemon is
       working properly. The Securics API is an open source 'RESTful' API that allows for interaction with the Securics
...
from securics_testing.constants.api import AGENTS_ROUTE, CONFIGURATION_TYPES
