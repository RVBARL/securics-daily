...
def test_configuration_location(test_configuration, test_metadata, truncate_monitored_files, configure_local_internal_options,
                                remove_all_localfiles_securics_config, set_securics_configuration, daemons_handler, wait_for_logcollector_start):
    '''
    description: Check if the 'securics-logcollector' daemon starts properly when the 'journald' tag is used and read the logs from the 'systemd/journald' component.
    ...
    assertions:
        ...
        - Verify that the Securics component (agent or manager) can read the logs from the 'systemd-journald'.
