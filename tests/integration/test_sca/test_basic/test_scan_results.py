...
references:
    - https://documentation.rvbionics.com/current/user-manual/capabilities/sec-config-assessment/index.html
...
from securics_testing.modules.modulesd.sca import patterns
...
def test_sca_scan_results(test_configuration, test_metadata, prepare_cis_policies_file, truncate_monitored_files,
                          set_securics_configuration, configure_local_internal_options, daemons_handler,
    ...
    parameters:
        - configuration:
            type: dict
            brief: Securics configuration data. Needed for set_securics_configuration fixture.
        - metadata:
            type: dict
            brief: Securics configuration metadata.
        - prepare_cis_policies_file:
            type: fixture
            brief: copy test sca policy file. Delete it after test.
        - set_securics_configuration:
            type: fixture
            brief: Set the securics configuration according to the configuration data.
        ...
        - restart_modulesd_function:
            type: fixture
            brief: Restart the securics-modulesd daemon.
        - wait_for_sca_enabled:
            type: fixture
