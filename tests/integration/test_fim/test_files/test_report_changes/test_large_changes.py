...
from securics_testing.utils.file import truncate_file, write_file_write
...
def test_large_changes(test_configuration, test_metadata, configure_local_internal_options,
                        truncate_monitored_files, set_securics_configuration, folder_to_monitor, daemons_handler, detect_end_scan):
    '''
    description: Check if the 'securics-syscheckd' daemon detects the character limit in the file changes is reached
