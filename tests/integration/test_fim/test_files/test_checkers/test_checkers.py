...
def test_checkers(test_configuration, test_metadata, set_securics_configuration, configure_local_internal_options,
                  truncate_monitored_files, folder_to_monitor, file_to_monitor, daemons_handler, start_monitoring):
    '''
    description: Check if the 'securics-syscheckd' daemon adds in the generated events the 'check_' specified in
