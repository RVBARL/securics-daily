...
from securics_testing.constants.paths.configurations import SECURICS_CLIENT_KEYS_PATH, DEFAULT_AUTHD_PASS_PATH
from securics_testing.tools.simulators.authd_simulator import AuthdSimulator
from securics_testing.utils.file import write_file, remove_file
...
def set_keys(test_metadata):
    ...
    for key in test_metadata.get('pre_existent_keys', []):
        write_file(SECURICS_CLIENT_KEYS_PATH, key)
