...
from securics_testing.utils.sockets import get_host_name
...
cases_path = Path(TEST_CASES_PATH, 'cases_securics_agent_auth.yaml')
config_path = Path(CONFIGS_PATH, 'config_securics_agent_auth.yaml')
...
def test_agent_auth_enrollment(test_configuration, test_metadata, set_securics_configuration, daemons_handler_module,
