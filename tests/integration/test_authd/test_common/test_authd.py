...
brief: These tests will check if the 'securics-authd' daemon correctly handles the enrollment requests,
       ...
       The 'securics-authd' daemon can automatically add a Securics agent to a Securics manager and provide
...
def test_ossec_auth_messages(test_configuration, test_metadata, set_securics_configuration,
    ...
    '''
    description:
        Checks if when the `securics-authd` daemon receives different types of enrollment requests,
