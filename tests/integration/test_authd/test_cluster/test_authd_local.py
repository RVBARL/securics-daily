...
brief: This module verifies the correct behavior of 'securics-authd' under different messages
...
from securics_testing.constants.paths.sockets import SECURICS_DB_SOCKET_PATH, AUTHD_SOCKET_PATH
...
# Variables
receiver_sockets_params = [(AUTHD_SOCKET_PATH, 'AF_UNIX', 'TCP'), (SECURICS_DB_SOCKET_PATH, 'AF_UNIX', 'TCP')]

daemons_handler_configuration = {'all_daemons': True}

# TODO Replace or delete
monitored_sockets_params = [(SECURICS_DB_DAEMON, None, True), (AUTHD_DAEMON, None, True)]
receiver_sockets, monitored_sockets = None, None


# Tests
@pytest.mark.parametrize('test_configuration,test_metadata', zip(test_configuration, test_metadata), ids=test_cases_ids)
def test_authd_local_messages(test_configuration, test_metadata, set_securics_configuration, configure_sockets_environment_module,
