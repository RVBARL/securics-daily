...
brief: These tests will check if the 'securics-authd' daemon correctly handles the key requests
...
def test_key_request_func(test_configuration, test_metadata, set_securics_configuration, connect_to_sockets,
