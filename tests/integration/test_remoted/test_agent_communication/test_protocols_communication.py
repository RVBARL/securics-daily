...
from securics_testing.modules.analysisd.patterns import ANALYSISD_STARTED
from securics_testing.tools.mitm import ManInTheMiddle
...
def test_protocols_communication(test_configuration, test_metadata, configure_local_internal_options, truncate_monitored_files,
                            set_securics_configuration, daemons_handler, simulate_agents, configure_sockets_environment_module,
