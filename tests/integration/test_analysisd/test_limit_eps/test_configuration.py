...
def test_accepted_values(test_configuration, test_metadata, load_securics_basic_configuration, set_securics_configuration,
    ...
    test_phases:
        ...
        - test:
            ...
            - Check that securics-analysisd is running (it has not been crashed).
        - teardown:
            - Truncate securics logs.
    ...
    """
    # Start monitor
    monitor_enabled = file_monitor.FileMonitor(SECURICS_LOG_PATH)
...
def test_invalid_values(test_configuration, test_metadata, load_securics_basic_configuration, set_securics_configuration,
                        truncate_monitored_files, daemons_handler):
    """
    description: Check for configuration error and securics-analysisd if the EPS limiting configuration has unaccepted
    ...
    test_phases:
        ...
        - test:
            - Restart securics-manager service to apply configuration changes.
            - Check that a configuration error is raised when trying to start securics-manager.
            - Check that securics-analysisd is not running (due to configuration error).
        - teardown:
            - Truncate securics logs.
            - Restore initial configuration.
    ...
    """
    # Start monitor
    monitor_error = file_monitor.FileMonitor(SECURICS_LOG_PATH)
...
def test_missing_configuration(test_configuration, test_metadata, load_securics_basic_configuration, set_securics_configuration,
    ...
    test_phases:
        ...
        - test:
            ...
            - Check whether the EPS limitation is activated, deactivated or generates a configuration error due to a
              missing label.
            - Check if securics-analysisd is running or not (according to the expected behavior).
        - teardown:
            - Truncate securics logs.
            - Restore initial configuration.
