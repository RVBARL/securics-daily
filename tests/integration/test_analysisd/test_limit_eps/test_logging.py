...
from securics_testing.utils import callbacks, configuration, file
...
def test_dropping_events(test_configuration, test_metadata, load_securics_basic_configuration, set_securics_configuration,
