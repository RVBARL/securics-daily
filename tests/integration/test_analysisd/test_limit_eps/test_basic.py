...
def test_enabled(test_configuration, test_metadata, load_securics_basic_configuration, set_securics_configuration,
...
def test_disabled(test_configuration, test_metadata, load_securics_basic_configuration, set_securics_configuration,
                 truncate_monitored_files, daemons_handler):
    """
    ...
    """
    # Start monitor
    monitor_disabled = file_monitor.FileMonitor(SECURICS_LOG_PATH)
