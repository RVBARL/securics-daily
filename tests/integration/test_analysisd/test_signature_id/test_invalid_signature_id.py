...
from securics_testing.modules.analysisd.testrule import patterns
...
def test_invalid_signature_id(test_configuration, test_metadata, set_securics_configuration, truncate_monitored_files,
    ...
    assertions:
        - Check that securics starts
        - Check ".*securics-testrule.*Empty 'if_sid' value. Rule '(\\d*)' will be ignored.*"
    ...
    '''
    # Start monitor
    monitor_invalid = file_monitor.FileMonitor(SECURICS_LOG_PATH)
