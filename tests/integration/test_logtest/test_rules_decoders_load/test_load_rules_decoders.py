...
references:
    ...
    - https://documentation.rvbionics.com/current/user-manual/ruleset/testing.html?highlight=logtest
    - https://documentation.rvbionics.com/current/user-manual/capabilities/securics-logtest/logtest-configuration.html
...
def test_load_rules_decoders(test_metadata, daemons_handler_module, wait_for_logtest_startup,
    ...
    '''
    description: Check if 'securics-logtest' does produce the right decoder/rule matching when processing a log under
