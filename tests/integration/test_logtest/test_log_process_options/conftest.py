...
from securics_testing.constants import users
from securics_testing.constants.paths.configurations import CUSTOM_RULES_FILE
...
def configure_rules_list(test_metadata):
    ...
    Restart Securics is not needed for applying the configuration, is optional.
    """
    ...
    shutil.chown(CUSTOM_RULES_FILE, users.SECURICS_UNIX_USER, users.SECURICS_UNIX_GROUP)
