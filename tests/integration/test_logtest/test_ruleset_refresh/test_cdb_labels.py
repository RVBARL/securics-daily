...
references:
    ...
    - https://documentation.rvbionics.com/current/user-manual/ruleset/cdb-list.html
...
def test_cdb_list(test_configuration, test_metadata, set_securics_configuration,
